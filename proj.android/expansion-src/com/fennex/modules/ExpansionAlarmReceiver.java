 ...
 *         	<receiver android:name="com.auticiel.modules.ExpansionAlarmReceiver" android:enabled="true" />
 */
public class ExpansionAlarmReceiver extends BroadcastReceiver 
{
    ...
    public void onReceive(Context context, Intent intent) 
    {
        try 
        {
            DownloaderClientMarshaller.startDownloadServiceIfRequired(context, intent, ExpansionSupport.class);
        } 
