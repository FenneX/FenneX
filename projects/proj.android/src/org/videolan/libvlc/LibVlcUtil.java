...
public class LibVlcUtil {
    ...
    public static void updateLibVlcSettings(SharedPreferences pref) {
        ...
        {
        	Log.i(TAG, "Device 4.3 or later, use Hardware acceleration");
        	instance.setHardwareAcceleration(2);
        }
        else
        {
        	Log.i(TAG, "Device earlier than 4.3, don't use Hardware acceleration");
        	instance.setHardwareAcceleration(-1);
        }
    }
